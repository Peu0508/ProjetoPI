      ...
      <View style={{height: 400, backgroundColor: COLORS.background}}>
        ...
        <View style={style.detailsContainer}>
          ...
          <View
            ...
            <Text style={{fontSize: 12, color: COLORS.dark}}>{'Arara'}</Text>
            <Text style={{fontSize: 13, color: COLORS.dark}}>{'2 Anos'}</Text>
          </View>
      ...
      <View style={{marginTop: 80, justifyContent: 'space-between', flex: 1}}>
        <View>
          ...
          <Text style={style.comment}>
            Meu emprego necessita que eu me mude para outro país. Eu não tenho como levar o gato comigo e estou procurando por uma boa pessoa que possa cuidar do Coco.
          </Text>
        </View>
